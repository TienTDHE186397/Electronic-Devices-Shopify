...
public class EditControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String msold = request.getParameter("sold");
        int mcinema = Integer.parseInt(request.getParameter("cinema"));
        int mcategory = Integer.parseInt(request.getParameter("categoryid"));
        
        
        DAO dao = new DAO();
        dao.editMovies(mid, mname, mgenre, mdirector, mperformer, mprice, mage, mimage, mbanner, mdescription, mview, mtime, mdate, msold, mcategory, mcinema);
