    ...
    <body>
        ...
        <div class="side-content">
            ...
            <div class="side-menu">
                <ul>
                    <li>
                       <a href="admin?PersonID=${sessionScope.user.personID}" class="">
                    ...
                    <li>
                        <a href="chart?PersonID=${sessionScope.user.personID}" class="active">
                    ...
                    <li>
                        <a href="settingList?PersonID=${sessionScope.user.personID}" class="">
