    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <div class="side-content">
                <div class="profile">
                    <input type="hidden" id="PersonID" name="PersonID" value="${sessionScope.user.personID}"/>
                ...
                <div class="side-menu">
                    <ul>
                        <li>
                            <a name="PersonID" href="admin?PersonID=${sessionScope.user.personID}" class="active">
                        ...
                        <li>
                            <a href="chart?PersonID=${sessionScope.user.personID}">
                        ...
                        <li>
                            <a href="adminProfile?PersonID=${sessionScope.user.personID}">
                                <span class="las la-user-alt"></span>
                                <small>Profile</small>
                            </a>
                        </li>
                        <li>
                            <a href="userList?PersonID=${sessionScope.user.personID}">
                                <span class="las la-tasks"></span>
                                <small>User List</small>
                            </a>
                        </li>
                        <li>
                            <a href="settingList?PersonID=${sessionScope.user.personID}">
                ...
                <div class="header-content">
                    ...
                    <div class="header-menu">
                        ...
                        <div class="user">
                            ...
                            <span onclick="window.location.href = './LogoutServlet'">Logout</span>
                        </div>
                    </div>
                </div>
            </header>
