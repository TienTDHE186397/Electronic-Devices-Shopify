...
public class MailSender {
    ...
    public static void sendVerificationEmail(String recipientEmail, String verificationCode) {
      ...
      public static void sendAccountBank(String recipientEmail, String AccountName , String BankName,String AccountNumber, String Order) {
        if (recipientEmail == null || recipientEmail.isEmpty()) {
            throw new IllegalArgumentException("Email không thể là null hoặc rỗng");
        }
//        if (verificationCode == null || verificationCode.isEmpty()) {
...
//        }
        ...
        String message = "sua sua sua" + AccountName + BankName + AccountNumber + Order;
...
//        sendVerificationEmail("Sonnvhhe182275@fpt.edu.vn", token);
        sendAccountBank("nghiemducls123@gmail.com", "sex", "sex", "sex", "sex");
