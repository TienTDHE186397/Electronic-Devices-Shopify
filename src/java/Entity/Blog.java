...
public class Blog {
    ...
    public Blog(int blogID, String blog_img, String blog_tittle, String blog_type, String blog_summary_information,
            Date blog_update_time, String blog_detail, int blog_views, String blog_status, Person person) {
        this.blogID = blogID;
