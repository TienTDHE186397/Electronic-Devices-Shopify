...
public class Blog {
    ...
    public Blog(int blogID, String blog_img, String blog_img_tittle, String blog_tittle, String blog_type, String blog_summary_information, String blog_update_time, String blog_detail, int blog_views, String blog_status, int blog_flag, Person person) {
        this.blogID = blogID;
    ...
    public String getBlog_update_time() {
        return blog_update_time;
    }

    public void setBlog_update_time(String blog_update_time) {
        this.blog_update_time = blog_update_time;
    }
