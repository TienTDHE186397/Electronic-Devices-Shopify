                            ...
                            <tbody>
                                <c:forEach items="${listacc}" var="a">
                                    <tr>
                                        ...
                                        <td>
                                            <span id="password${a.ID}">********</span>
                                            <button type="button" onclick="togglePassword(${a.ID}, '${a.pass}')" class="btn btn-link">
                                                <i id="eyeIcon${a.ID}" class="fa fa-eye"></i>
                                            </button>
                                        </td>
                                        ...
                                        <c:choose>
                                            ...
                                            <c:when test="${a.isSell == 1}">
                                                <td style="color: blue">Staff</td>
                                            </c:when>
                                            <c:otherwise>
                                                <td>User</td>
                                            </c:otherwise>
                                        ...
                                        <c:if test="${a.roleID == 0}">
                                            <td><span class="status text-danger">&bull;</span> Normal</td>
                                        </c:if>
                                        <td>
                                            <c:if test="${a.roleID == 0}">
                                                <a href="editaccount?aid=${a.ID}" class="settings" title="Settings" data-toggle="tooltip"><i class="material-icons">&#xE8B8;</i></a>
                                                <a href="deleteaccount?aid=${a.ID}" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE5C9;</i></a>
                                            </c:if>
                                        </td>
                                    </tr>
                                </c:forEach>
