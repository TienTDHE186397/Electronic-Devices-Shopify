...
<body>
    ...
    <section id="subs" class="pt-5 pb-5 bg_light_1">
        <div class="container text-center">
            <h1 class="brand-name">${cinema.cinemaname}</h1>
        </div>
    </section>
        ...
        <div class="container-xl">
            <div class="row prod_1 mb-4 text-center">
                <div class="col-md-12">
                    ...
                    <h4 class="mb-0 col_yell mt-3">Phim Sắp Chiếu</h4>
                </div>
            </div>
            <div class="row prod_2 text-center">
                <!-- Đang fix cứng 8 phim lặp lại -->
                <c:forEach items="${listsc}" var="o">  
                ...
                <di    v class="col-md-12  col-lg-8">
                    <div class="deal_1r">
                        <div class="deal_1r1 row">
                            <div class="col-md-6">
                                <div class="deal_1r1l ">
                                    <h6 class="h_line font_30">Currently Showing</h6>
                                    <h4 class="mb-0 col_yell mt-3">Phim Đang Chiếu</h4>
                                </div>
                            </div>
                            <div class="col-md-6">
    ...
    <div class="container-xl">
        <div class="row prod_1 mb-4 text-center">
            <div class="col-md-12">
                ...
                <h2 class="mb-0 col_yell mt-3">Bộ Sưu Tập Đặc Biệt</h2>
            </div>
        </div>
                            ...
                            <div class="col-md-3">
                                <div class="prod_2im position-relative clearfix">
                                    <div class="prod_2i1 clearfix">
                                        <div class="grid clearfix">
                                            <figure class="effect-jazz mb-0">
                                                <a href="detail.html"><img src="${mv.image}" class="w-100" alt="abc"></a>
                                            </figure>
                                        </div>
                                    </div>
                                    <div class="prod_2i2 pt-4 pb-4 ps-3 pe-3  clearfix">
                                        <h6 class="ellipsis"><a href="detail.html" style="color: #000; font-size: 1.5em; text-align: left;">${mv.productName}</a></h6>
    ...
    <div class="container-xl">
        <div class="row prod_1 mb-4 text-center">
            <div class="col-md-12">
                ...
                <h2 class="mb-0 col_yell mt-3">Phim Đã Chiếu</h2>
            </div>
        </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="blog_h1i">
                        ...
                        <div class="blog_h1i1 bg-white pt-4 pb-4 ps-3 pe-3">
                            <h6 class="font_14 col_light"><i class="fa fa-calendar col_yell me-1"></i> OCTOBER 23, 2020</h6>
