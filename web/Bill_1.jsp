                            ...
                            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="img\bill\bill.png" class="d-block w-100" alt="abc">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="detail_1r">
                            ...
                            <c:if test="${sessionScope.acc.isSell == 1}">
                                ...
                                <a href="billcancel" class="btn btn-primary text-uppercase mt-2" style="font-size: 1em; padding: 10px 20px; text-align: center; text-decoration: none; color: white; background-color: #f7ba01">
                                    Hủy
                                </a>
                                <a href="billcuscess?totalm=${total}" class="btn btn-primary text-uppercase mt-2" style="font-size: 1em; padding: 10px 20px; text-align: center; text-decoration: none; color: white; background-color: #f7ba01">
                                    Hoàn Tất Thanh Toán
                                </a>
                            </c:if>
                            ...
                            <c:if test="${sessionScope.acc.roleID == 0 && sessionScope.acc.isSell == 0}">
                                <form action="onlinebill" method="post">
                                    ...
                                    <button type="submit" class="btn btn-primary text-uppercase mt-2" style="font-size: 1em; padding: 10px 20px; text-align: center; text-decoration: none; color: white; background-color: #f7ba01">
                                        Hoàn Tất Thanh Toán
                                    </button>
                                    <br><hr>
