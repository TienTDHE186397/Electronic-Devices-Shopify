    ...
    <div class="container">
        ...
        <form action="editSetting" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="image" name="image" value="${setting.image}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" id="order" name="order" value="${setting.order}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="status" name="status" value="${setting.status}" required>
            </div>
